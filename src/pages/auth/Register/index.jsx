...
export default function Register() {
  ...
  return (
    <div>
      ...
      <p className="text-muted mb-4">Join Rehaish to find verified rentals and trusted flatmates</p>
      ...
      <div className="text-center text-muted">
        Already have an account? <Link className="auth-link" to="/auth/login">Login</Link>
      </div>
    </div>
  );
}
